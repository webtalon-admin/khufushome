...
- [ ] **Supabase cron schedule** — `pg_cron` quarterly trigger for the YourSuper + BTC price Edge Functions
...
- [ ] **Sidebar dropdown** — expand "Super" in the sidebar to show sub-page links (Analysis Overview, Historical, Projections, Research, Allocations, Fees) as a collapsible sub-menu
- [ ] **Breadcrumb/tab navigation** — add a persistent navigation bar at the top of all `/super/*` sub-pages with links back to the super landing page and between sibling pages
