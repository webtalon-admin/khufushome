...
export function AuthLayout({ children, className }: AuthLayoutProps) {
	return (
		...
		>
			...
			{/* Glowing moon */}
			<div className="pointer-events-none absolute top-[12%] right-[10%] size-14 rounded-full bg-gradient-to-br from-accent-warm-200 to-accent-warm-400 opacity-70 shadow-[0_0_40px_8px_rgba(251,191,36,0.15)] sm:right-[15%] sm:size-16" />
